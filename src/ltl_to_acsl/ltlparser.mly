...
logic_relation
	: arith_relation LTL_EQ  arith_relation
            { (	Prel(Cil_types.Req, Logic_utils.expr_to_term $1 ,Logic_utils.expr_to_term  $3),
		new_exp (BinOp(Cil_types.Eq, $1 , $3 , Cil.intType)) )
	    }
	| arith_relation LTL_LT  arith_relation
            { (	Prel(Cil_types.Rlt, Logic_utils.expr_to_term $1 , Logic_utils.expr_to_term $3),
		new_exp (BinOp(Cil_types.Lt, $1 , $3 , Cil.intType)) )
	    }
	| arith_relation LTL_GT  arith_relation
            { (	Prel(Cil_types.Rgt, Logic_utils.expr_to_term $1 , Logic_utils.expr_to_term $3),
		new_exp(BinOp(Cil_types.Gt, $1 , $3 , Cil.intType)) )
	    }
	| arith_relation LTL_LE  arith_relation
            { (	Prel(Cil_types.Rle, Logic_utils.expr_to_term $1 , Logic_utils.expr_to_term $3),
		new_exp (BinOp(Cil_types.Le, $1 , $3 , Cil.intType) ))
	    }
	| arith_relation LTL_GE  arith_relation
            { (	Prel(Cil_types.Rge, Logic_utils.expr_to_term $1 , Logic_utils.expr_to_term $3),
		new_exp (BinOp(Cil_types.Ge, $1 , $3 , Cil.intType) ))
	    }
	| arith_relation LTL_NEQ arith_relation
            { (	Prel(Cil_types.Rneq,Logic_utils.expr_to_term $1 , Logic_utils.expr_to_term $3),
		new_exp (BinOp(Cil_types.Ne , $1 , $3 , Cil.intType) ))
	    }
	| arith_relation
	    { (	Prel(Cil_types.Rneq,Logic_utils.expr_to_term $1 ,
		     Logic_const.term
...
access
	: access_array LTL_RIGHT_ARROW  access
            { Ltl_to_acsl_option.fatal "NOT YET IMPLEMENTED : A->B pointed structure filed access." }
...
access_leaf
        : LTL_ADRESSE access
            { Ltl_to_acsl_option.fatal "NOT YET IMPLEMENTED : &A 'address of' access." }
	| LTL_STAR access

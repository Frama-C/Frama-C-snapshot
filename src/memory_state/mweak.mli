...
(* $Id: mweak.mli,v 1.9 2008/04/01 09:25:21 uid568 Exp $ *)
...
(** [Weak.check ar n] returns [true] if the [n]th cell of [ar] is
   ...
   returns [true], a subsequent {!Mweak.get}[ ar n] can return [None].*)
...
module Make (H : WeakHashable) : S with type data = H.t;;

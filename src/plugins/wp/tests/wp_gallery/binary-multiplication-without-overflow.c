/* run.config
   OPT: -warn-unsigned-overflow @PTEST_FILE@ -wp-no-print -wp-rte
*/

/* run.config_qualif
   OPT: -warn-unsigned-overflow @PTEST_FILE@ -wp-prop=-lack -then -warn-unsigned-overflow -wp-rte -wp -wp-prop=-lack
*/

let default_suites : string list ref = ref [ "occurrence"; "rte"; "idct"; "test"; "misc"; "float"; "constant_propagation"; "impact"; "pdg"; "scope"; "sparecode"; "slicing"; "slicing2"; "aorai"; "wp"; "dynamic"; "dynamic_plugin"; "journal"; "saveload"; "spec"; ];;

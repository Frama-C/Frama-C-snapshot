...
(*Why predicate*) Definition lt_pointer (A698:Set) (p1:(pointer A698)) (p2:(pointer A698))
  := (base_addr p1) = (base_addr p2) /\ (offset p1) < (offset p2).
Implicit Arguments lt_pointer.

(*Why predicate*) Definition le_pointer (A699:Set) (p1:(pointer A699)) (p2:(pointer A699))
  := (base_addr p1) = (base_addr p2) /\ (offset p1) <= (offset p2).
Implicit Arguments le_pointer.

(*Why predicate*) Definition gt_pointer (A700:Set) (p1:(pointer A700)) (p2:(pointer A700))
  := (base_addr p1) = (base_addr p2) /\ (offset p1) > (offset p2).
Implicit Arguments gt_pointer.

(*Why predicate*) Definition ge_pointer (A701:Set) (p1:(pointer A701)) (p2:(pointer A701))
  := (base_addr p1) = (base_addr p2) /\ (offset p1) >= (offset p2).
Implicit Arguments ge_pointer.

(*Why predicate*) Definition valid (A702:Set) (a:alloc_table) (p:(pointer A702))
  := 0 <= (offset p) /\ (offset p) < (block_length a p).
Implicit Arguments valid.

(*Why predicate*) Definition valid_index (A703:Set) (a:alloc_table) (p:(pointer A703)) (i:Z)
  := 0 <= ((offset p) + i) /\ ((offset p) + i) < (block_length a p).
Implicit Arguments valid_index.

(*Why predicate*) Definition valid_range (A704:Set) (a:alloc_table) (p:(pointer A704)) (i:Z) (j:Z)
...
(*Why predicate*) Definition not_assigns (A748:Set) (A747:Set) (a:alloc_table) (m1:(memory A747 A748)) (m2:(memory A747 A748)) (l:(pset A748))
  := (forall (p:(pointer A748)),
...
(*Why predicate*) Definition valid_acc (A789:Set) (A788:Set) (m1:(memory (pointer A788) A789))
  := (forall (p:(pointer A789)),
      (forall (a:alloc_table), ((valid a p) -> (valid a (acc m1 p))))).
Implicit Arguments valid_acc.

(*Why predicate*) Definition valid_acc_range (A791:Set) (A790:Set) (m1:(memory (pointer A790) A791)) (size:Z)
  := (forall (p:(pointer A791)),
      (forall (a:alloc_table),
...
(*Why predicate*) Definition separation1 (A795:Set) (A794:Set) (m1:(memory (pointer A794) A795)) (m2:(memory (pointer A794) A795))
  := (forall (p:(pointer A795)),
      (forall (a:alloc_table),
       ((valid a p) -> ~((base_addr (acc m1 p)) = (base_addr (acc m2 p)))))).
Implicit Arguments separation1.

(*Why predicate*) Definition separation1_range1 (A797:Set) (A796:Set) (m1:(memory (pointer A796) A797)) (m2:(memory (pointer A796) A797)) (size:Z)
...
(*Why predicate*) Definition separation1_range (A799:Set) (A798:Set) (m:(memory (pointer A798) A799)) (size:Z)
...
(*Why predicate*) Definition separation2 (A801:Set) (A800:Set) (m1:(memory (pointer A800) A801)) (m2:(memory (pointer A800) A801))
  := (forall (p1:(pointer A801)),
      (forall (p2:(pointer A801)),
       (~(p1 = p2) -> ~((base_addr (acc m1 p1)) = (base_addr (acc m2 p2)))))).
Implicit Arguments separation2.

(*Why predicate*) Definition separation2_range1 (A803:Set) (A802:Set) (m1:(memory (pointer A802) A803)) (m2:(memory (pointer A802) A803)) (size:Z)
  := (forall (p:(pointer A803)),
      (forall (q:(pointer A803)),
       (forall (a:alloc_table),
        (forall (i:Z),
         (0 <= i /\ i < size ->

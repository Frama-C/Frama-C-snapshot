...
(*Why predicate*) Definition lt_pointer (A634:Set) (p1:((pointer) A634))
  (p2:((pointer) A634))
  := (base_addr p1) = (base_addr p2) /\ (offset p1) < (offset p2).
Implicit Arguments lt_pointer.

(*Why predicate*) Definition le_pointer (A635:Set) (p1:((pointer) A635))
  (p2:((pointer) A635))
  := (base_addr p1) = (base_addr p2) /\ (offset p1) <= (offset p2).
Implicit Arguments le_pointer.

(*Why predicate*) Definition gt_pointer (A636:Set) (p1:((pointer) A636))
  (p2:((pointer) A636))
  := (base_addr p1) = (base_addr p2) /\ (offset p1) > (offset p2).
Implicit Arguments gt_pointer.

(*Why predicate*) Definition ge_pointer (A637:Set) (p1:((pointer) A637))
  (p2:((pointer) A637))
  := (base_addr p1) = (base_addr p2) /\ (offset p1) >= (offset p2).
Implicit Arguments ge_pointer.

(*Why predicate*) Definition valid (A638:Set) (a:alloc_table)
  (p:((pointer) A638)) := 0 <= (offset p) /\ (offset p) < (block_length a p).
Implicit Arguments valid.

(*Why predicate*) Definition valid_index (A639:Set) (a:alloc_table)
  (p:((pointer) A639)) (i:Z)
  := 0 <= ((offset p) + i) /\ ((offset p) + i) < (block_length a p).
Implicit Arguments valid_index.

(*Why predicate*) Definition valid_range (A640:Set) (a:alloc_table)
  (p:((pointer) A640)) (i:Z) (j:Z)
...
Admitted.
Implicit Arguments shift_shift.
...
Admitted.
Implicit Arguments base_addr_shift.
...
Admitted.
Implicit Arguments block_length_shift.
   ...
   (forall (p1:((pointer) A1)),
    (forall (p2:((pointer) A1)),
     ((base_addr p1) = (base_addr p2) -> (block_length a p1) =
      (block_length a p2))))).
Admitted.
Implicit Arguments base_addr_block_length.
...
Admitted.
Implicit Arguments pointer_pair_1.
...
Admitted.
Implicit Arguments pointer_pair_2.
...
Admitted.
Implicit Arguments neq_base_addr_neq_shift.
...
Admitted.
Implicit Arguments neq_offset_neq_shift.
...
Admitted.
Implicit Arguments eq_offset_eq_shift.
...
Admitted.
Implicit Arguments valid_index_valid_shift.
...
Admitted.
Implicit Arguments valid_range_valid_shift.
...
Admitted.
Implicit Arguments valid_range_valid.
...
Admitted.
Implicit Arguments valid_range_valid_index.
  ...
  (forall (p1:((pointer) A1)),
   (forall (p2:((pointer) A1)),
    ((base_addr p1) = (base_addr p2) -> (sub_pointer p1 p2) =
     ((offset p1) - (offset p2))))).
Admitted.
Implicit Arguments sub_pointer_def.
...
(*Why predicate*) Definition not_assigns (A684:Set)
  (A683:Set) (a:alloc_table) (m1:((memory) A683 A684)) (m2:((memory) A683
  A684)) (l:((pset) A684))
...
Admitted.
Implicit Arguments pset_empty_intro.
...
Admitted.
Implicit Arguments pset_singleton_intro.
...
Admitted.
Implicit Arguments pset_union_intro.
...
Admitted.
Implicit Arguments pset_union_elim1.
...
Admitted.
Implicit Arguments pset_union_elim2.
...
Admitted.
Implicit Arguments pset_star_intro.
   ...
   (forall (m:((memory) ((pointer) A2) A1)),
    (forall (p:((pointer) A2)),
     ((not_in_pset p (pset_star l m)) ->
      (forall (p1:((pointer) A1)), (p = (acc m p1) -> (not_in_pset p1 l))))))).
Admitted.
Implicit Arguments pset_star_elim.
...
Admitted.
Implicit Arguments pset_all_intro.
   ...
   (forall (l:((pset) A1)),
    ((not_in_pset p (pset_all l)) ->
     (forall (p1:((pointer) A1)),
      (~(not_in_pset p1 l) -> ~((base_addr p) = (base_addr p1))))))).
Admitted.
Implicit Arguments pset_all_elim.
...
Admitted.
Implicit Arguments pset_range_intro.
...
Admitted.
Implicit Arguments pset_range_elim.
...
Admitted.
Implicit Arguments pset_range_left_intro.
...
Admitted.
Implicit Arguments pset_range_left_elim.
...
Admitted.
Implicit Arguments pset_range_right_intro.
...
Admitted.
Implicit Arguments pset_range_right_elim.
...
Admitted.
Implicit Arguments pset_acc_all_intro.
...
Admitted.
Implicit Arguments pset_acc_all_elim.
...
Admitted.
Implicit Arguments pset_acc_range_intro.
...
Admitted.
Implicit Arguments pset_acc_range_elim.
...
Admitted.
Implicit Arguments pset_acc_range_left_intro.
...
Admitted.
Implicit Arguments pset_acc_range_left_elim.
...
Admitted.
Implicit Arguments pset_acc_range_right_intro.
...
Admitted.
Implicit Arguments pset_acc_range_right_elim.
...
Admitted.
Implicit Arguments not_assigns_trans.
...
Admitted.
Implicit Arguments not_assigns_refl.

(*Why predicate*) Definition valid_acc (A725:Set)
  (A724:Set) (m1:((memory) ((pointer) A724) A725))
  := (forall (p:((pointer) A725)),
      (forall (a:alloc_table), ((valid a p) -> (valid a (acc m1 p))))).
Implicit Arguments valid_acc.

(*Why predicate*) Definition valid_acc_range (A727:Set)
  (A726:Set) (m1:((memory) ((pointer) A726) A727)) (size:Z)
  := (forall (p:((pointer) A727)),
      (forall (a:alloc_table),
...
Admitted.
Implicit Arguments valid_acc_range_valid.

(*Why predicate*) Definition separation1 (A731:Set)
  (A730:Set) (m1:((memory) ((pointer) A730) A731))
  (m2:((memory) ((pointer) A730) A731))
  := (forall (p:((pointer) A731)),
      (forall (a:alloc_table),
       ((valid a p) -> ~((base_addr (acc m1 p)) = (base_addr (acc m2 p)))))).
Implicit Arguments separation1.

(*Why predicate*) Definition separation1_range1 (A733:Set)
  (A732:Set) (m1:((memory) ((pointer) A732) A733))
  (m2:((memory) ((pointer) A732) A733)) (size:Z)
  := (forall (p:((pointer) A733)),
      (forall (a:alloc_table),
       ((valid a p) ->
        (forall (i:Z),
         (0 <= i /\ i < size ->
...
(*Why predicate*) Definition separation1_range (A735:Set)
  (A734:Set) (m:((memory) ((pointer) A734) A735)) (size:Z)
...
(*Why predicate*) Definition separation2 (A737:Set)
  (A736:Set) (m1:((memory) ((pointer) A736) A737))
  (m2:((memory) ((pointer) A736) A737))
  := (forall (p1:((pointer) A737)),
      (forall (p2:((pointer) A737)),
       (~(p1 = p2) -> ~((base_addr (acc m1 p1)) = (base_addr (acc m2 p2)))))).
Implicit Arguments separation2.

(*Why predicate*) Definition separation2_range1 (A739:Set)
  (A738:Set) (m1:((memory) ((pointer) A738) A739))
  (m2:((memory) ((pointer) A738) A739)) (size:Z)
  := (forall (p:((pointer) A739)),
      (forall (q:((pointer) A739)),
       (forall (a:alloc_table),
        (forall (i:Z),
         (0 <= i /\ i < size ->
...
Admitted.
Implicit Arguments fresh_not_valid.
...
Admitted.
Implicit Arguments fresh_not_valid_shift.
...
Admitted.
Implicit Arguments alloc_extends_valid.
...
Admitted.
Implicit Arguments alloc_extends_valid_index.
...
Admitted.
Implicit Arguments alloc_extends_valid_range.
...
Admitted.
Implicit Arguments free_stack_heap.
...
Admitted.
Implicit Arguments free_stack_stack.

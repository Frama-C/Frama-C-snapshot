/* run.config
   ...
   OPT: -aorai-automata tests/aorai/test_recursion4.ya -aorai-test 1 -aorai-acceptance -load-module tests/aorai/aorai_test.cmxs
*/

# pragma JessieIntegerModel(math)

/*@ requires \valid_range(t,0,size-1);
  @ requires size>=0;
  @ decreases size;

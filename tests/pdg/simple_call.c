/* run.config
   ...
   OPT: -main call_in_loop -pdg-debug "-fct-pdg call_in_loop"
   OPT: -main call_mix_G1_G2 -pdg-debug "-fct-pdg call_mix_G1_G2"
   OPT: -main call_multiple_global_outputs -pdg-debug "-fct-pdg call_multiple_global_outputs"
*/

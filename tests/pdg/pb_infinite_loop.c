/* run.config
   GCC:
   OPT: -main test_infinite_loop -fct-pdg test_infinite_loop -journal-disable
   OPT: -main test_infinite_loop_2 -fct-pdg test_infinite_loop_2 -journal-disable
   OPT: -main test_exit -fct-pdg test_exit -journal-disable
*/

/* run.config
   OPT: -ltl tests/ltl_to_acsl/test_factorial.ltl -ltl-test 1
*/
...
frama-c -jessie-analysis tests/ltl_to_acsl/test_factorial.c -jessie-int-model exact -jessie-gui 
frama-c tests/ltl_to_acsl/test_factorial.c  -ltl tests/ltl_to_acsl/test_factorial.ltl -ltl-dot 
frama-c -jessie-analysis tests/ltl_to_acsl/test_factorial_annot.c -jessie-int-model exact -jessie-gui 
 */

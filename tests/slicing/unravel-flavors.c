/* run.config
   GCC:
   OPT: -slice-print -slice-undef-functions -slice-return send1
   OPT: -slice-print -slice-undef-functions -slice-return send2
   OPT: -slice-print -slice-undef-functions -slice-return send3
   OPT: -slice-print -slice-undef-functions -slice-return send4
   */

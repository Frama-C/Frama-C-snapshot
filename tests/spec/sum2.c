...
/*@ logic int sum{L}(int t[], integer i, integer j)
  @  reads i,j,t,t[..] ;
  @*/
...
/*@ axiom sum2{L} :
  @   \forall int t[], integer i, j; sum(t,i,j+1) == sum(t,i,j) + t[j];
  @*/
...
/*
Local Variables:
compile-command: "../../bin/toplevel.byte -jessie-analysis -jessie-output sum2.jc sum2.c ; jessie sum2.jc ; make -f sum2.makefile gui"
End:
*/
